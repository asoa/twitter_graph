...
def main():
    try:
        ...
        # crawl = Crawl(twitter_api=auth.twitter_api, screen_name='BarackObama', node_max=15)
        ...
        g = Graph(file='twitter_graph_COOLVISIONLLC.txt', use_name=True, twitter_api=auth.twitter_api)
